...
class Ldap extends Base
{
    ...
    public function LdapTest()
    {
        if (!function_exists('ldap_connect')) {
            return message(200, 0, 'Vui lòng cài đặt phần phụ thuộc ldap của php trước');
        }
        ...
        if (!in_array($type, ['connection', 'user', 'group'])) {
            return message(200, 0, 'loại xác thực không hợp lệ');
        }
        ...
        if (!$connection) {
            return message(200, 0, 'Kết nối thất bại');
        }
        ...
        if (!$result) {
            return message(200, 0, sprintf('Kết nối thất bại: %s', ldap_error($connection)));
        }
    ...
    public function SyncLdapToAuthz()
    {
        ...
        if (is_numeric($authzContent)) {
            if ($authzContent == 612) {
                ...
                return message(200, 0, "mã lỗi$authzContent");
            }
        }
