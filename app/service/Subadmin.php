...
class Subadmin extends Base
{
    ...
    public function CreateSubadmin()
    {
        ...
        $this->Logs->InsertLog(
            ...
            sprintf("tên tài thư mụcản:%s", $this->payload['subadmin_name']),
            $this->userName
        );
    ...
    public function DelSubadmin()
    {
        ...
        $this->Logs->InsertLog(
            'xóa quản trị viên phụ',
            sprintf("tên tài thư mụcản:%s", $subadminName),
            $this->userName
        );
    ...
    public function UpdSubadminPass()
    {
        ...
        //日志
        $this->Logs->InsertLog(
            'Sửa đổi mật khẩu quản trị viên phụ',
            sprintf("tên tài thư mụcản:%s", $subadminName),
            $this->userName
        );
    ...
    public function UpdSubadminStatus()
    {
        ...
        //日志
        $this->Logs->InsertLog(
            'Sửa đổi trạng thái quản trị viên phụ',
            sprintf("tên tài thư mụcản:%s tình trạng:%s", $subadminName, $this->payload['status'] == true ? 'cho phép' : 'disabled'),
            $this->userName
        );
